...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('a', cancel_p, gettext('Cancelar'), 'href', 'javascript:DateTimeShortcuts.dismissClock(' + num + ');');
    },
    ...
    addCalendar: function(inp) {
        ...
        today_link.appendChild(document.createTextNode(gettext('Hoy')));
        ...
        quickElement('a', shortcuts, gettext('Ayer'), 'href', 'javascript:DateTimeShortcuts.handleCalendarQuickLink(' + num + ', -1);');
        shortcuts.appendChild(document.createTextNode('\240|\240'));
        quickElement('a', shortcuts, gettext('Hoy'), 'href', 'javascript:DateTimeShortcuts.handleCalendarQuickLink(' + num + ', 0);');
        shortcuts.appendChild(document.createTextNode('\240|\240'));
        quickElement('a', shortcuts, gettext('Mañana'), 'href', 'javascript:DateTimeShortcuts.handleCalendarQuickLink(' + num + ', +1);');

        // cancel bar
        var cancel_p = quickElement('p', cal_box, '');
        cancel_p.className = 'calendar-cancel';
        quickElement('a', cancel_p, gettext('Cancelar'), 'href', 'javascript:DateTimeShortcuts.dismissCalendar(' + num + ');');
    },
