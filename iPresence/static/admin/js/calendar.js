...
var CalendarNamespace = {
    monthsOfYear: gettext('Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre').split(' '),
    daysOfWeek: gettext('D L M M J V S').split(' '),
